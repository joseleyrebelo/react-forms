...
export type ValidationTypes = 'password' | 'match' | 'email' | 'notEmpty' | 'disabled'

export type TailoredValidations = Extract<ValidationTypes, 'match' | 'password'>
...
export type ActionableValidations = Exclude<ValidationTypes, UnactionableValidations>
...
export type DynamicValidationProp = BluntValidations | MatchValidation | PasswordValidation

export type ParsedValidationProp = Exclude<DynamicValidationProp, BluntValidations> | { type: BluntValidations }
...
// @todo revise organisation of types
